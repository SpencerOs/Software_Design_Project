...
//File -> import -> project from SVN -> choose repository -> choose location to save it
public class Main 
{

  // Probably should declare any buttons here
  public static JButton lbutton,rbutton, mbutton;
  

  public static void main(String[] args)
  {
    // This is the play area
    GameWindow game = new GameWindow("Group D aMaze");
